...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = [
      ...
      '',
      'Rules:',
      '- For any tax, GST, VAT, or service charge line items: these must be',
      '  distributed proportionally among all diners based on their share of the',
      '  pre-tax subtotal. Do NOT split tax equally. Calculate each person\'s tax',
      '  share as: (their_subtotal / total_subtotal) * tax_amount. A person who',
      '  only had non-alcoholic food still pays GST on their food items. A person',
      '  who had no items in a category pays zero tax related to that category.',
